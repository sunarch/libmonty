...
_responses = {
    ...
    "101": {
        ...
        "description": ("This code is sent in response to an Upgrade request header from the client, "
    ...
    "102": {
        ...
        "description": ("This code indicates that the server has received and is processing the request, "
                        "but no response is available yet."),
        "link": "https://developer.mozilla.org/en-US/docs/Glossary/WebDAV"
    },
    "103": {
        "title": "Early Hints",
        "description": ("This status code is primarily intended to be used with the Link header, "
