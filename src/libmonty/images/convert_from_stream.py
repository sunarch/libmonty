...
_MODE_RGB = "RGB"  # (3x8-bit pixels, true color)
...
def rgb(folder: str,
    ...
    img = PIL.Image.frombytes(_MODE_RGB, size, data, decoder_name=_DECODER_RAW)
    ...
    if scale is not None:
        ...
        img2 = PIL.Image.frombytes(_MODE_RGB, size, data, decoder_name=_DECODER_RAW)
